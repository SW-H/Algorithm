...
bool checkException(int n) {
    ...
    if ((_1000 == _100) || (_1000 == _10) || (_1000 == _1) || (_100 == _10)|| (_100 == _1)|| (_10 == _1)) {
        return false;
    }
    return true;
}
...
void doUserImplementation(int guess[]) {
    ...
    while (1) {
        if (checkException(candidateN)) {
            makeArr(guess, candidateN);
            if(query(guess).hit == 4)
                return;
        }
        candidateN++;
    }
